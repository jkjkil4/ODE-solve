...
#let thm-theorem = thmbox("thm-theorem", "定理", fill: maroon.lighten(90%), base_level: 1).with(numbering: thm-numbering)

#let thm-proof = thmplain("thm-proof", [*证明*]).with(numbering: none)
...
#let thm-warn = thmbox("thm-tip", "注", fill: orange.lighten(90%)).with(numbering: none)
